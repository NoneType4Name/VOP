...
namespace Engine
{
    ...
    //     pass::pass()  = default;
    //     pass::~pass() = default;
    //     pass::pass( types::subpassLink subpassesLink, Engine::types::link link ) {}
    // } // namespace render
    // namespace templates
    // {
    ...
    //     }
    // } // namespace templates
    void setup( types::link link, VkRenderPassCreateInfo &createInfo, std::vector<void *> &dataPointer, void *userPointer )
    {
    ...
    pass::pass( types::link link )
    {
        ...
        setup( data->link, createInfo, pData, data->link->data->window->data->instance->data->userPointer );
        createInfo.sType = VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO;
