...
namespace Engine
{
    namespace tools
    {
        ...
        void setupDebugLayerCallback()
        {
            ...
            auto _crtDbgUtMsgrEXT = ( PFN_vkCreateDebugUtilsMessengerEXT )vkGetInstanceProcAddr( getInstance(), "vkCreateDebugUtilsMessengerEXT" );
            if( _crtDbgUtMsgrEXT != nullptr )
            {
                CHECK_RESULT( _crtDbgUtMsgrEXT( getInstance(), &DebugUtilsMessengerCreateInfoEXT, nullptr, &_debugMessenger ) );
            }
            else
            {
        ...
        void destroyDebugLayerCallback()
        {
            ...
            {
                PFN_vkDestroyDebugUtilsMessengerEXT destroyMsgCallback = ( PFN_vkDestroyDebugUtilsMessengerEXT )( void * )vkGetInstanceProcAddr( getInstance(), "vkDestroyDebugUtilsMessengerEXT" );
                destroyMsgCallback( getInstance(), _debugMessenger, ALLOCATION_CALLBACK );
            }
        }
    } // namespace tools
} // namespace Engine